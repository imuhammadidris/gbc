		...
		<div class="row justify-content-between align-items-center">
			...
			<div class="col align-right">
				...
				<div class="head-action">
					...
					<?php if ( $cryptex_settings['header-style-3-search'] ): ?>
						<div class="search-holder">
							<button type="button" class="search-button"></button>
						</div>
					<?php endif; ?>

					<?php if ( $cryptex_settings['header-style-3-button'] ): ?>
						<a href="<?php echo esc_url($cryptex_settings['header-style-3-button-link']) ?>" class="btn btn-style-3 btn-big"><?php echo esc_html($cryptex_settings['header-style-3-button-text']) ?></a>
					<?php endif; ?>

					<?php if ( defined('ICL_LANGUAGE_CODE') ): ?>
						<?php if ( $cryptex_settings['header-style-3-show-language'] ): ?>
