...
if ( !class_exists('Cryptex_Shop_Cart') ) {

	class Cryptex_Shop_Cart {

		public $action_cart_item_remove = 'cryptex_cart_item_remove';
		public $action_refresh_cart_fragment = 'cryptex_refresh_cart_fragment';
