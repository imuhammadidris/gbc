...
window.CryptexSubTabView = window.VcColumnView.extend({
	events:{
	...
	render:function () {
		...
		window.CryptexSubTabView.__super__.render.call(this);
		if(!params.tab_id) {
	...
	ready:function (e) {
		...
		window.CryptexSubTabView.__super__.ready.call(this, e);
		this.$tabs = this.$el.closest('.wpb_tabs_holder');
		var params = this.model.get('params');
		//console && console.log('CryptexSubTabView.ready() loading');
		return this;
	},
	changeShortcodeParams:function (model) {
		var params = model.get('params');
		window.CryptexSubTabView.__super__.changeShortcodeParams.call(this, model);
		//var params = model.get('params');
		...
		//console && console.log('CryptexSubTabView changeShortcodeParams loading');
	},
	deleteShortcode:function (e) {
		...
		// console && console.log('CryptexSubTabView.deleteShortcode loading');
	},
	cloneModel:function (model, parent_id, save_order) {
		...
		//console && console.log('CryptexSubTabView.cloneModel loading');
		return model_clone;
	}
