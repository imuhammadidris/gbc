...
window.CryptexTabView = vc.shortcode_view.extend({
	...
	initialize:function (params) {
            window.CryptexTabView.__super__.initialize.call(this, params);
            _.bindAll(this, 'stopSorting');
           //console && console.log('CryptexTabView: initialize method called.');
        },
	// Render method called after element is added( cloned ), and on first initialisation
	render: function () {
        //console && console.log('CryptexTabView: render method called.');
		window.CryptexTabView.__super__.render.call(this); //make sure to call __super__. To execute logic fron inherited view. That way you can extend original logic. Otherwise, you will fully rewrite what VC will do at this event
		this.$tabs = this.$el.find('.wpb_tabs_holder');
        this.createAddTabButton();
        //console &&  console.log('CryptexTabView '+this.$tabs);
		return this;
	},
	ready: function (e) {
        //console && console.log('CryptexTabView: ready method called.');
		window.CryptexTabView.__super__.ready.call(this, e);
    ...
    createAddTabButton:function(){
    	var new_tab_button_id = (+new Date() + '-' + Math.floor(Math.random() * 11));
         ...
         //console &&  console.log(' CryptexTabView : createAddTabButton');
        },
    addTab:function (e) {
    	//console &&  console.log('addTab');
            ...
            //console &&  console.log(' CryptexTabView :  addTab');
            return false;
        },
        stopSorting:function (event, ui) {
            var shortcode;
             //console &&  console.log(' CryptexTabView :  stopSorting loading');
            this.$tabs.find('ul.tabs_controls li:not(.add_tab_block)').each(function (index) {
              ...
              //console &&  console.log(' CryptexTabView :  shortcode save');
            shortcode.save();
        },
       changedContent:function (view) {
            ...
            //console &&  console.log(' CryptexTabView :  changedContent save');
        },
...
// Come from vc_map -> 'js_view' => 'CryptexTabView'
})(window.jQuery);
